...
"use client";
import MainForm from "../form/Hero";
  ...
  return (
    <div className="relative">
      <motion.div
        ...
        viewport={{ once: true }}
      >
        <div className=" lg:aspect-[32:9] bg-primary rounded-xl">
          <HeroCarousel />
        </div>
      </motion.div>
      <motion.div
      ...
      <motion.div
        ...
        viewport={{ once: true }}
      >
        <div className="container bg-violet-50 px-7 py-0   mt-0 rounded-lg">
          <div className=" mt-2 py-3 flex items-center text-muted-foreground text-sm gap-x-1.5 after:flex-[1_1_0%] after:border-t after:ms-6 after:border-t-muted-foreground/50">
            <span className="font-semibold text-primary">50,000</span>
            individuals trust our platform for flight booking
          </div>
